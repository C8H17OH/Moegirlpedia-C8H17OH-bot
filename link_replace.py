...
def link_replace(old_title: str, new_title: str, keep_no_caption: bool = False, show_diff: bool = False, auto_submit: bool = False):
    site = pywikibot.Site()
...
def link_replace_main():
    ...
    if args.old_title and args.new_title:
        link_replace(args.old_title, args.new_title, args.keep_no_caption, args.show_diff, args.auto_submit)
